  ...
  <body>
    ...
    <?php
      if(isset($_POST['update']))
      {
        ...
        $sql = "UPDATE Phones SET customerID='$customerID', name='$cName', phone_number='$phoneNumb', shipping_address='$shippingAdd', email_address='$emailAdd' WHERE serial_numb='$serialnumber'";
